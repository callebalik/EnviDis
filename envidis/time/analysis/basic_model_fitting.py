...
class BasicModelFitter:
    ...
    def print_results(self) -> None:
        ...
        print(
            f"Negative Binomial AIC: {comparison['nb_aic']:.2f}, BIC: {comparison['nb_bic']:.2f}",
        )
        print(
            f"{comparison['chosen_model']} model has {comparison['reason']}, suggesting a better fit.",
        )
        print(
            f"Proceeding with {comparison['chosen_model']} model for further analysis.",
        )
