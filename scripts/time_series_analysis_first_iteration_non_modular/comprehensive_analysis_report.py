...
class ComprehensiveAnalysisReport:
    ...
    def create_comprehensive_visualization(self):
        ...
        bars1 = ax3.bar(
            x - width / 2, aic_values, width, label="AIC", alpha=0.8, color=colors[3]
        )
        bars2 = ax3.bar(
            x + width / 2, bic_values, width, label="BIC", alpha=0.8, color=colors[4]
        )
        ...
        ax7.set_title(
            "G. Autocorrelation Function of Residuals", fontsize=12, fontweight="bold"
        )
